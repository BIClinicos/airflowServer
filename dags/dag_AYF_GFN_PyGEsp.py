...
filename = 'AYF_GFN_PyGEsp.xlsx'
db_table = "AYF_GFN_PyGEsp"
db_tmp_table = "tmp_AYF_GFN_PyGEsp"
...
with DAG(dag_name,
    ...
    get_AYF_GFN_PyGEsp_python_task = PythonOperator(task_id = "get_AYF_GFN_PyGEsp",
        python_callable = func_get_AYF_GFN_PyGEsp)
    
    # Se declara la función encargada de ejecutar el "Stored Procedure"
    load_AYF_GFN_PyGEsp = MsSqlOperator(task_id='Load_AYF_GFN_PyGEsp',
                                       mssql_conn_id=sql_connid,
                                       autocommit=True,
                                       sql="EXECUTE sp_load_AYF_GFN_PyGEsp",
                                       )

    # Se declara la función que sirva para denotar la Terminación del DAG, por medio del operador "DummyOperator"
    task_end = DummyOperator(task_id='task_end')

start_task >>check_connection_task >> get_AYF_GFN_PyGEsp_python_task >> load_AYF_GFN_PyGEsp >> task_end