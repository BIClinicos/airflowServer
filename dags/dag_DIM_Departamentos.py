...
filename = 'dptos.xlsx'
db_table = "DIM_Departamentos"
db_tmp_table = "tmp_DIM_Departamentos"
...
def func_get_DIM_Departamentos ():
...
with DAG(dag_name,
    ...
    get_DIM_Departamentos_python_task = PythonOperator(task_id = "get_DIM_Departamentos",
        python_callable = func_get_DIM_Departamentos)
    
    # Se declara la función encargada de ejecutar el "Stored Procedure"
    load_DIM_Departamentos = MsSqlOperator(task_id='Load_DIM_Departamentos',
                                       mssql_conn_id=sql_connid,
                                       autocommit=True,
                                       sql="EXECUTE sp_load_DIM_Departamentos",
                                       )

    # Se declara la función que sirva para denotar la Terminación del DAG, por medio del operador "DummyOperator"
    task_end = DummyOperator(task_id='task_end')

start_task >>check_connection_task >> get_DIM_Departamentos_python_task >> load_DIM_Departamentos >> task_end