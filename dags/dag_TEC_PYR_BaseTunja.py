...
filename = 'TEC_PYR_OportunidadTunja.xlsx'
...
dag_name = 'dag_' + 'TEC_PYR_BaseTunja'
...
def func_get_TEC_PYR_BaseTunja ():    
    ...
    print('before_drop_duplicates',df_patients)
    df_patients = df_patients.drop_duplicates(subset=['document_number','document_type'])
    print('after_drop_duplicates',df_patients)
...
with DAG(dag_name,
    ...
    get_TEC_PYR_BaseTunja_python_task = PythonOperator(task_id = "get_TEC_PYR_BaseTunja",
                                                  python_callable = func_get_TEC_PYR_BaseTunja,
                                                  email_on_failure=True, 
                                                  email='BI@clinicos.com.co'
                                                  )
    
   # Se declara la función encargada de ejecutar el "Stored Procedure"
    load_TEC_PYR_BaseTunja_dim = MsSqlOperator(task_id='Load_TEC_PYR_BaseTunja_dim',
    ...
    # Se declara la función encargada de ejecutar el "Stored Procedure"
    load_TEC_PYR_BaseTunja_fact = MsSqlOperator(task_id='Load_TEC_PYR_BaseTunja_fact',
                                        mssql_conn_id=sql_connid,
                                        autocommit=True,
...
start_task >> get_TEC_PYR_BaseTunja_python_task >> load_TEC_PYR_BaseTunja_dim >> load_TEC_PYR_BaseTunja_fact >>task_end