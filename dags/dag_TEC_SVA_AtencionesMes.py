...
filename = 'TEC_SVA_AtencionesMes.xlsx'
db_table = "TEC_SVA_AtencionesMes"
db_tmp_table = "tmp_TEC_SVA_AtencionesMes"
...
def transform_tables (path):
    ...
    df = df[['sede', 'unidad', 'mes', 'atenciones']]

    return df

def func_get_TEC_SVA_AtencionesMes ():    
    ...
    df = df.drop_duplicates(subset=['sede', 'unidad', 'mes'])
...
with DAG(dag_name,
    ...
    get_TEC_SVA_AtencionesMes_python_task = PythonOperator(task_id = "get_TEC_SVA_AtencionesMes",
                                                           python_callable = func_get_TEC_SVA_AtencionesMes,
    ...
    load_TEC_SVA_AtencionesMes = MsSqlOperator(task_id='Load_TEC_SVA_AtencionesMes',
                                       mssql_conn_id=sql_connid,
                                       autocommit=True,
                                       sql="EXECUTE sp_load_TEC_SVA_AtencionesMes",
                                       email_on_failure=True, 
                                       email='BI@clinicos.com.co',
                                       dag=dag,
                                       )
...
start_task >> get_TEC_SVA_AtencionesMes_python_task >> load_TEC_SVA_AtencionesMes>> task_end