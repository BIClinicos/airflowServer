...
db_tmp_table = 'tmp_TblHActividadesPAMI'
...
def transform_table(dir, filenames):
    ...
    df_tele_ind5['sede'] = 'Clinicos'
    df_tele_ind5.columns = ['fecha', 'detalle', 'cantidad', 'concepto', 'sede']
    #
    df_tele_ind6 = pd.read_excel(dir + filenames[2], header = [0], sheet_name = 'LineaSaludResolutividad')
    ...
    df_tele_ind6['sede'] = 'Clinicos'
    df_tele_ind6.columns = ['fecha', 'detalle', 'cantidad', 'concepto', 'sede']    
    #
    df_tele_ind7 = pd.read_excel(dir + filenames[2], header = [0], sheet_name = 'LineaSaludTriage')
    ...
    #
    df_tele_ind8 = pd.read_excel(dir + filenames[2], header = [0], sheet_name = 'LineaSalud')
    ...
    #
    df_tele_ind9 = pd.read_excel(dir + filenames[2], header = [0], sheet_name = 'Perfil')
