...
db_table = "dimPatients"
db_tmp_table = "tmp_dimPatients"
dag_name = 'dag_' + db_table

# Función de extracción del archivo del blob al servidor, transformación del dataframe y cargue a la base de datos mssql
def func_get_dimPatients ():
...
with DAG(dag_name,
    ...
    # Se establece la ejecución del dag a las 9:20 am (hora servidor) todos los Jueves
    schedule_interval= '20 9 * * 04',
    max_active_runs=1
    ) as dag:
    ...
    get_dimPatients_python_task = PythonOperator(task_id = "get_dimPatients",
                                                python_callable = func_get_dimPatients,
    ...
    load_dimPatients = MsSqlOperator(task_id='Load_dimPatients',
                                        mssql_conn_id=sql_connid,
                                        autocommit=True,
                                        sql="EXECUTE sp_load_dimPatients",
                                        email_on_failure=True, 
                                        email='BI@clinicos.com.co',
                                        dag=dag
                                       )
...
start_task >> get_dimPatients_python_task >> load_dimPatients >> task_end